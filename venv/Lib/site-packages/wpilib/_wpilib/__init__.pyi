...
class ADXL362(ErrorBase, wpilib.interfaces._interfaces.Accelerometer, Sendable):
    ...
    class Axes():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kAxis_X': Axes.kAxis_X, 'kAxis_Y': Axes.kAxis_Y, 'kAxis_Z': Axes.kAxis_Z}
        kAxis_X: wpilib._wpilib.ADXL362.Axes # value = Axes.kAxis_X
        kAxis_Y: wpilib._wpilib.ADXL362.Axes # value = Axes.kAxis_Y
        kAxis_Z: wpilib._wpilib.ADXL362.Axes # value = Axes.kAxis_Z
        pass
    @typing.overload
...
class AnalogInput(ErrorBase, wpilib.interfaces._interfaces.PIDSource, Sendable):
    ...
    def getAccumulatorCount(self) -> int: 
        ...
        """
    def getAccumulatorOutput(self, value: int, count: int) -> None: 
        """
...
class InterruptableSensorBase(ErrorBase):
    class WaitResult():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kTimeout': WaitResult.kTimeout, 'kRisingEdge': WaitResult.kRisingEdge, 'kFallingEdge': WaitResult.kFallingEdge, 'kBoth': WaitResult.kBoth}
        kBoth: wpilib._wpilib.InterruptableSensorBase.WaitResult # value = WaitResult.kBoth
        kFallingEdge: wpilib._wpilib.InterruptableSensorBase.WaitResult # value = WaitResult.kFallingEdge
        kRisingEdge: wpilib._wpilib.InterruptableSensorBase.WaitResult # value = WaitResult.kRisingEdge
        kTimeout: wpilib._wpilib.InterruptableSensorBase.WaitResult # value = WaitResult.kTimeout
        pass
    def __init__(self) -> None: ...
...
class AnalogTriggerType():
    ...
    kFallingPulse: wpilib._wpilib.AnalogTriggerType # value = AnalogTriggerType.kFallingPulse
    kInWindow: wpilib._wpilib.AnalogTriggerType # value = AnalogTriggerType.kInWindow
    kRisingPulse: wpilib._wpilib.AnalogTriggerType # value = AnalogTriggerType.kRisingPulse
    kState: wpilib._wpilib.AnalogTriggerType # value = AnalogTriggerType.kState
    pass
...
class CAN(ErrorBase):
    ...
    def writeRTRFrame(self, length: int, apiId: int) -> None: 
        ...
        :param apiId: The API ID to write.
        """
    kTeamDeviceType: hal._wpiHal.CANDeviceType # value = CANDeviceType.kMiscellaneous
    kTeamManufacturer: hal._wpiHal.CANManufacturer # value = CANManufacturer.kTeamUse
    pass
class CANData():
    def __init__(self) -> None: ...
    @property
...
class Counter(ErrorBase, wpilib.interfaces._interfaces.CounterBase, Sendable):
    ...
    class Mode():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kTwoPulse': Mode.kTwoPulse, 'kSemiperiod': Mode.kSemiperiod, 'kPulseLength': Mode.kPulseLength, 'kExternalDirection': Mode.kExternalDirection}
        kExternalDirection: wpilib._wpilib.Counter.Mode # value = Mode.kExternalDirection
        kPulseLength: wpilib._wpilib.Counter.Mode # value = Mode.kPulseLength
        kSemiperiod: wpilib._wpilib.Counter.Mode # value = Mode.kSemiperiod
        kTwoPulse: wpilib._wpilib.Counter.Mode # value = Mode.kTwoPulse
        pass
    @typing.overload
    def __init__(self, channel: int) -> None: 
        """
...
class DriverStation(ErrorBase):
    ...
    class Alliance():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kRed': Alliance.kRed, 'kBlue': Alliance.kBlue, 'kInvalid': Alliance.kInvalid}
        kBlue: wpilib._wpilib.DriverStation.Alliance # value = Alliance.kBlue
        kInvalid: wpilib._wpilib.DriverStation.Alliance # value = Alliance.kInvalid
        kRed: wpilib._wpilib.DriverStation.Alliance # value = Alliance.kRed
        pass
    class MatchType():
        """
        Members:
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kNone': MatchType.kNone, 'kPractice': MatchType.kPractice, 'kQualification': MatchType.kQualification, 'kElimination': MatchType.kElimination}
        kElimination: wpilib._wpilib.DriverStation.MatchType # value = MatchType.kElimination
        kNone: wpilib._wpilib.DriverStation.MatchType # value = MatchType.kNone
        kPractice: wpilib._wpilib.DriverStation.MatchType # value = MatchType.kPractice
        kQualification: wpilib._wpilib.DriverStation.MatchType # value = MatchType.kQualification
        pass
...
class Encoder(ErrorBase, wpilib.interfaces._interfaces.CounterBase, wpilib.interfaces._interfaces.PIDSource, Sendable):
    ...
    class IndexingType():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kResetWhileHigh': IndexingType.kResetWhileHigh, 'kResetWhileLow': IndexingType.kResetWhileLow, 'kResetOnFallingEdge': IndexingType.kResetOnFallingEdge, 'kResetOnRisingEdge': IndexingType.kResetOnRisingEdge}
        kResetOnFallingEdge: wpilib._wpilib.Encoder.IndexingType # value = IndexingType.kResetOnFallingEdge
        kResetOnRisingEdge: wpilib._wpilib.Encoder.IndexingType # value = IndexingType.kResetOnRisingEdge
        kResetWhileHigh: wpilib._wpilib.Encoder.IndexingType # value = IndexingType.kResetWhileHigh
        kResetWhileLow: wpilib._wpilib.Encoder.IndexingType # value = IndexingType.kResetWhileLow
        pass
    @typing.overload
...
class ADXL345_I2C(ErrorBase, wpilib.interfaces._interfaces.Accelerometer, Sendable):
    ...
    class Axes():
        ...
        def name(self) -> None:
            ...
            """
        __members__: dict # value = {'kAxis_X': Axes.kAxis_X, 'kAxis_Y': Axes.kAxis_Y, 'kAxis_Z': Axes.kAxis_Z}
        kAxis_X: wpilib._wpilib.ADXL345_I2C.Axes # value = Axes.kAxis_X
        kAxis_Y: wpilib._wpilib.ADXL345_I2C.Axes # value = Axes.kAxis_Y
        kAxis_Z: wpilib._wpilib.ADXL345_I2C.Axes # value = Axes.kAxis_Z
        pass
...
class I2C(ErrorBase):
    ...
    class Port():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kOnboard': Port.kOnboard, 'kMXP': Port.kMXP}
        kMXP: wpilib._wpilib.I2C.Port # value = Port.kMXP
        kOnboard: wpilib._wpilib.I2C.Port # value = Port.kOnboard
        pass
...
class PWM(MotorSafety, ErrorBase, Sendable):
    ...
    class PeriodMultiplier():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kPeriodMultiplier_1X': PeriodMultiplier.kPeriodMultiplier_1X, 'kPeriodMultiplier_2X': PeriodMultiplier.kPeriodMultiplier_2X, 'kPeriodMultiplier_4X': PeriodMultiplier.kPeriodMultiplier_4X}
        kPeriodMultiplier_1X: wpilib._wpilib.PWM.PeriodMultiplier # value = PeriodMultiplier.kPeriodMultiplier_1X
        kPeriodMultiplier_2X: wpilib._wpilib.PWM.PeriodMultiplier # value = PeriodMultiplier.kPeriodMultiplier_2X
        kPeriodMultiplier_4X: wpilib._wpilib.PWM.PeriodMultiplier # value = PeriodMultiplier.kPeriodMultiplier_4X
        pass
    def __init__(self, channel: int) -> None: 
        """
...
class Joystick(wpilib.interfaces._interfaces.GenericHID):
    ...
    class AxisType():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kXAxis': AxisType.kXAxis, 'kYAxis': AxisType.kYAxis, 'kZAxis': AxisType.kZAxis, 'kTwistAxis': AxisType.kTwistAxis, 'kThrottleAxis': AxisType.kThrottleAxis}
        kThrottleAxis: wpilib._wpilib.Joystick.AxisType # value = AxisType.kThrottleAxis
        kTwistAxis: wpilib._wpilib.Joystick.AxisType # value = AxisType.kTwistAxis
        kXAxis: wpilib._wpilib.Joystick.AxisType # value = AxisType.kXAxis
        kYAxis: wpilib._wpilib.Joystick.AxisType # value = AxisType.kYAxis
        kZAxis: wpilib._wpilib.Joystick.AxisType # value = AxisType.kZAxis
        pass
    class ButtonType():
        """
        Members:
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kTriggerButton': ButtonType.kTriggerButton, 'kTopButton': ButtonType.kTopButton}
        kTopButton: wpilib._wpilib.Joystick.ButtonType # value = ButtonType.kTopButton
        kTriggerButton: wpilib._wpilib.Joystick.ButtonType # value = ButtonType.kTriggerButton
        pass
    def __init__(self, port: int) -> None: 
        """
...
class Relay(MotorSafety, ErrorBase, Sendable):
    ...
    class Direction():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kBothDirections': Direction.kBothDirections, 'kForwardOnly': Direction.kForwardOnly, 'kReverseOnly': Direction.kReverseOnly}
        kBothDirections: wpilib._wpilib.Relay.Direction # value = Direction.kBothDirections
        kForwardOnly: wpilib._wpilib.Relay.Direction # value = Direction.kForwardOnly
        kReverseOnly: wpilib._wpilib.Relay.Direction # value = Direction.kReverseOnly
        pass
    class Value():
        """
        Members:
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kOff': Value.kOff, 'kOn': Value.kOn, 'kForward': Value.kForward, 'kReverse': Value.kReverse}
        kForward: wpilib._wpilib.Relay.Value # value = Value.kForward
        kOff: wpilib._wpilib.Relay.Value # value = Value.kOff
        kOn: wpilib._wpilib.Relay.Value # value = Value.kOn
        kReverse: wpilib._wpilib.Relay.Value # value = Value.kReverse
        pass
...
class SPI(ErrorBase):
    ...
    class Port():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kOnboardCS0': Port.kOnboardCS0, 'kOnboardCS1': Port.kOnboardCS1, 'kOnboardCS2': Port.kOnboardCS2, 'kOnboardCS3': Port.kOnboardCS3, 'kMXP': Port.kMXP}
        kMXP: wpilib._wpilib.SPI.Port # value = Port.kMXP
        kOnboardCS0: wpilib._wpilib.SPI.Port # value = Port.kOnboardCS0
        kOnboardCS1: wpilib._wpilib.SPI.Port # value = Port.kOnboardCS1
        kOnboardCS2: wpilib._wpilib.SPI.Port # value = Port.kOnboardCS2
        kOnboardCS3: wpilib._wpilib.SPI.Port # value = Port.kOnboardCS3
        pass
    def __init__(self, port: SPI.Port) -> None: 
        """
        Constructor
...
class ADXL345_SPI(ErrorBase, wpilib.interfaces._interfaces.Accelerometer, Sendable):
    ...
    class Axes():
        ...
        def name(self) -> None:
            ...
            """
        __members__: dict # value = {'kAxis_X': Axes.kAxis_X, 'kAxis_Y': Axes.kAxis_Y, 'kAxis_Z': Axes.kAxis_Z}
        kAxis_X: wpilib._wpilib.ADXL345_SPI.Axes # value = Axes.kAxis_X
        kAxis_Y: wpilib._wpilib.ADXL345_SPI.Axes # value = Axes.kAxis_Y
        kAxis_Z: wpilib._wpilib.ADXL345_SPI.Axes # value = Axes.kAxis_Z
        pass
    def __init__(self, port: SPI.Port, range: wpilib.interfaces._interfaces.Accelerometer.Range = Range.kRange_2G) -> None: 
        """
        Constructor.
...
class SensorUtil():
    ...
    def getDefaultSolenoidModule() -> int: 
        ...
        """
    kAnalogInputs = 1668556287
    kDigitalChannels = 1668949503
    kPDPChannels = 1668818431
    kPwmChannels = 1668163071
    kRelayChannels = 1668294143
    kSolenoidChannels = 1668425215
    kSolenoidModules = 1668687359
    pass
class SerialPort(ErrorBase):
    ...
    class FlowControl():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kFlowControl_None': FlowControl.kFlowControl_None, 'kFlowControl_XonXoff': FlowControl.kFlowControl_XonXoff, 'kFlowControl_RtsCts': FlowControl.kFlowControl_RtsCts, 'kFlowControl_DtrDsr': FlowControl.kFlowControl_DtrDsr}
        kFlowControl_DtrDsr: wpilib._wpilib.SerialPort.FlowControl # value = FlowControl.kFlowControl_DtrDsr
        kFlowControl_None: wpilib._wpilib.SerialPort.FlowControl # value = FlowControl.kFlowControl_None
        kFlowControl_RtsCts: wpilib._wpilib.SerialPort.FlowControl # value = FlowControl.kFlowControl_RtsCts
        kFlowControl_XonXoff: wpilib._wpilib.SerialPort.FlowControl # value = FlowControl.kFlowControl_XonXoff
        pass
    class Parity():
        """
        Members:
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kParity_None': Parity.kParity_None, 'kParity_Odd': Parity.kParity_Odd, 'kParity_Even': Parity.kParity_Even, 'kParity_Mark': Parity.kParity_Mark, 'kParity_Space': Parity.kParity_Space}
        kParity_Even: wpilib._wpilib.SerialPort.Parity # value = Parity.kParity_Even
        kParity_Mark: wpilib._wpilib.SerialPort.Parity # value = Parity.kParity_Mark
        kParity_None: wpilib._wpilib.SerialPort.Parity # value = Parity.kParity_None
        kParity_Odd: wpilib._wpilib.SerialPort.Parity # value = Parity.kParity_Odd
        kParity_Space: wpilib._wpilib.SerialPort.Parity # value = Parity.kParity_Space
        pass
    class Port():
        """
        Members:
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kOnboard': Port.kOnboard, 'kMXP': Port.kMXP, 'kUSB': Port.kUSB, 'kUSB1': Port.kUSB, 'kUSB2': Port.kUSB2}
        kMXP: wpilib._wpilib.SerialPort.Port # value = Port.kMXP
        kOnboard: wpilib._wpilib.SerialPort.Port # value = Port.kOnboard
        kUSB: wpilib._wpilib.SerialPort.Port # value = Port.kUSB
        kUSB1: wpilib._wpilib.SerialPort.Port # value = Port.kUSB
        kUSB2: wpilib._wpilib.SerialPort.Port # value = Port.kUSB2
        pass
    class StopBits():
        """
        Members:
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kStopBits_One': StopBits.kStopBits_One, 'kStopBits_OnePointFive': StopBits.kStopBits_OnePointFive, 'kStopBits_Two': StopBits.kStopBits_Two}
        kStopBits_One: wpilib._wpilib.SerialPort.StopBits # value = StopBits.kStopBits_One
        kStopBits_OnePointFive: wpilib._wpilib.SerialPort.StopBits # value = StopBits.kStopBits_OnePointFive
        kStopBits_Two: wpilib._wpilib.SerialPort.StopBits # value = StopBits.kStopBits_Two
        pass
    class WriteBufferMode():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kFlushOnAccess': WriteBufferMode.kFlushOnAccess, 'kFlushWhenFull': WriteBufferMode.kFlushWhenFull}
        kFlushOnAccess: wpilib._wpilib.SerialPort.WriteBufferMode # value = WriteBufferMode.kFlushOnAccess
        kFlushWhenFull: wpilib._wpilib.SerialPort.WriteBufferMode # value = WriteBufferMode.kFlushWhenFull
        pass
    @typing.overload
...
class DoubleSolenoid(SolenoidBase, ErrorBase, Sendable):
    ...
    class Value():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kOff': Value.kOff, 'kForward': Value.kForward, 'kReverse': Value.kReverse}
        kForward: wpilib._wpilib.DoubleSolenoid.Value # value = Value.kForward
        kOff: wpilib._wpilib.DoubleSolenoid.Value # value = Value.kOff
        kReverse: wpilib._wpilib.DoubleSolenoid.Value # value = Value.kReverse
        pass
    @typing.overload
...
class Timer():
    ...
    def stop(self) -> None: 
        ...
        """
    kRolloverTime = 1.1448901446739514e-125
    pass
class Ultrasonic(ErrorBase, Sendable, wpilib.interfaces._interfaces.PIDSource):
    ...
    class DistanceUnit():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kInches': DistanceUnit.kInches, 'kMilliMeters': DistanceUnit.kMilliMeters}
        kInches: wpilib._wpilib.Ultrasonic.DistanceUnit # value = DistanceUnit.kInches
        kMilliMeters: wpilib._wpilib.Ultrasonic.DistanceUnit # value = DistanceUnit.kMilliMeters
        pass
    @typing.overload
...
class XboxController(wpilib.interfaces._interfaces.GenericHID):
    ...
    class Axis():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kLeftX': Axis.kLeftX, 'kRightX': Axis.kRightX, 'kLeftY': Axis.kLeftY, 'kRightY': Axis.kRightY, 'kLeftTrigger': Axis.kLeftTrigger, 'kRightTrigger': Axis.kRightTrigger}
        kLeftTrigger: wpilib._wpilib.XboxController.Axis # value = Axis.kLeftTrigger
        kLeftX: wpilib._wpilib.XboxController.Axis # value = Axis.kLeftX
        kLeftY: wpilib._wpilib.XboxController.Axis # value = Axis.kLeftY
        kRightTrigger: wpilib._wpilib.XboxController.Axis # value = Axis.kRightTrigger
        kRightX: wpilib._wpilib.XboxController.Axis # value = Axis.kRightX
        kRightY: wpilib._wpilib.XboxController.Axis # value = Axis.kRightY
        pass
    class Button():
        """
        Members:
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kBumperLeft': Button.kBumperLeft, 'kBumperRight': Button.kBumperRight, 'kStickLeft': Button.kStickLeft, 'kStickRight': Button.kStickRight, 'kA': Button.kA, 'kB': Button.kB, 'kX': Button.kX, 'kY': Button.kY, 'kBack': Button.kBack, 'kStart': Button.kStart}
        kA: wpilib._wpilib.XboxController.Button # value = Button.kA
        kB: wpilib._wpilib.XboxController.Button # value = Button.kB
        kBack: wpilib._wpilib.XboxController.Button # value = Button.kBack
        kBumperLeft: wpilib._wpilib.XboxController.Button # value = Button.kBumperLeft
        kBumperRight: wpilib._wpilib.XboxController.Button # value = Button.kBumperRight
        kStart: wpilib._wpilib.XboxController.Button # value = Button.kStart
        kStickLeft: wpilib._wpilib.XboxController.Button # value = Button.kStickLeft
        kStickRight: wpilib._wpilib.XboxController.Button # value = Button.kStickRight
        kX: wpilib._wpilib.XboxController.Button # value = Button.kX
        kY: wpilib._wpilib.XboxController.Button # value = Button.kY
        pass
    def __init__(self, port: int) -> None: 
        """
